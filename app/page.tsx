    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <a 
          href="https://cal.com" 
          target="_blank"
          className="inline-block bg-white text-black font-semibold text-2xl px-16 py-8 rounded-2xl hover:bg-zinc-200"
        >
          Buy Now - Book a Demo
        </a>

        <p className="mt-8 text-zinc-500">Includes full code transfer + setup help</p>
      </div>
    </div>
  );
}